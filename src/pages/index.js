				...
				<main className="w-full min-h-[86vh] flex flex-col">
					<div className="self-center justify-self-center my-auto px-4 mx-4">
						...
						<div className="flex flex-row content-between">
							<p><a className="link italic" href="https://www.github.com/audrey-yang" 
								target="_blank" rel="noreferrer" title="GitHub">github</a></p>
							<p><a className="link italic" href="https://www.linkedin.com/in/audreyryang/" 
								target="_blank" rel="noreferrer" title="Linkedin">linkedin</a></p>
							<p><a className="link italic" href="https://blog.aryang.dev/" 
								target="_blank" rel="noreferrer" title="Blog">blog</a></p>
							<p><a className="link italic" href="https://bsky.app/profile/aryang.bsky.social" 
								target="_blank" rel="noreferrer" title="Bluesky">bsky</a></p>
							<p><a className="link italic" href="https://media.ebird.org/catalog?sort=obs_date_desc&userId=USER7850062&view=grid" 
